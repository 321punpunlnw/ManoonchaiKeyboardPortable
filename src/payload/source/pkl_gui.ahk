...
ShowManoonchaiPanel()
{
	statusText := A_IsSuspended ? "Disabled - original keyboard layout is active" : "Enabled - Manoonchai is active"
	toggleText := A_IsSuspended ? "Enable Manoonchai" : "Disable Manoonchai"
	iconPath := A_IsSuspended ? getTrayIconInfo( "FileOff" ) : getTrayIconInfo( "FileOn" )

	Gui, ManoonchaiPanel:Destroy
	Gui, ManoonchaiPanel:+AlwaysOnTop +Resize +MinimizeBox +MaximizeBox
	Gui, ManoonchaiPanel:Color, F7F7F7
	Gui, ManoonchaiPanel:Margin, 14, 12
	Gui, ManoonchaiPanel:Font, s10, Segoe UI
	Gui, ManoonchaiPanel:Add, Picture, x14 y14 w42 h42 Icon1, %iconPath%
	Gui, ManoonchaiPanel:Font, s13 Bold, Segoe UI
	Gui, ManoonchaiPanel:Add, Text, x66 y13 w260 h24, Manoonchai Keyboard Portable
	Gui, ManoonchaiPanel:Font, s9 Norm, Segoe UI
	Gui, ManoonchaiPanel:Add, Text, x67 y38 w260 h22, %statusText%

	Gui, ManoonchaiPanel:Font, s10, Segoe UI
	Gui, ManoonchaiPanel:Add, Button, x14 y72 w150 h34 gManoonchaiPanelToggle, %toggleText%
	Gui, ManoonchaiPanel:Add, Button, x174 y72 w150 h34 gManoonchaiPanelHelper, Layout Helper
	Gui, ManoonchaiPanel:Add, Button, x14 y114 w150 h34 gManoonchaiPanelLayout, View Layout
	Gui, ManoonchaiPanel:Add, Button, x174 y114 w150 h34 gManoonchaiPanelFolder, Open Folder
	Gui, ManoonchaiPanel:Add, Button, x14 y156 w150 h34 gManoonchaiPanelClassicMenu, Classic PKL Menu
	Gui, ManoonchaiPanel:Add, Button, x174 y156 w150 h34 gManoonchaiPanelAbout, About

	Gui, ManoonchaiPanel:Font, s8, Segoe UI
	Gui, ManoonchaiPanel:Add, Text, x14 y204 w310 h18, Hotkeys: Ctrl+Alt+M toggle, Ctrl+Alt+H helper, Ctrl+Alt+Esc exit
	Gui, ManoonchaiPanel:Add, Button, x224 y226 w100 h30 gexitApp, Exit
	Gui, ManoonchaiPanel:Add, Button, x114 y226 w100 h30 gManoonchaiPanelClose, Close
	Gui, ManoonchaiPanel:+MinSize360x300
	Gui, ManoonchaiPanel:Show, w360 h300 Center, Manoonchai Keyboard
}
