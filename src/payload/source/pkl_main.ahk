...
ManoonchaiPanelToggle:
	Gui, ManoonchaiPanel:Destroy
	gosub ToggleSuspend
	ShowManoonchaiPanel()
return

ManoonchaiPanelHelper:
	pkl_displayHelpImage( 2 )
return

ManoonchaiPanelLayout:
	Run, %A_WorkingDir%\layouts\manoonchai\layout.html
return

ManoonchaiPanelFolder:
	Run, explorer.exe "%A_WorkingDir%"
return

ManoonchaiPanelClassicMenu:
	Menu, Tray, Show
return

ManoonchaiPanelAbout:
	pkl_about()
return

ManoonchaiPanelClose:
ManoonchaiPanelGuiClose:
ManoonchaiPanelGuiEscape:
	Gui, ManoonchaiPanel:Destroy
return
